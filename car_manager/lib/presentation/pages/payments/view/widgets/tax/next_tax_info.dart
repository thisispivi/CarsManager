...
class NextTaxInfo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final daysUntilNext = car.getDaysUntilNextTaxDue().toString();
    ...
    return Padding(
      ...
      child: Text.rich(
        TextSpan(
          children: [
            TextSpan(
              text: "${localizations.payments_taxesData_nextDue}: ",
            ...
            TextSpan(
              text:
                  "${dateFormat.format(nextTaxDate)} ($daysUntilNext ${localizations.days})",
              style: GoogleFonts.spaceGrotesk(
                fontSize: 16,
